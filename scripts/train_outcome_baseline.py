...
from features.outcome import FEATURE_COLUMNS, OUTCOMES, build_dataset
...
def main() -> None:
    ...
    save_xgb_model(xgb_result.model, "outcome", FEATURE_COLUMNS, sorted(OUTCOMES))
    print()
    print("Saved XGBoost model to artifacts/outcome.xgb.json")
